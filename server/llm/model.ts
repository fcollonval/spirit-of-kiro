...
const bedrockClient = new BedrockRuntimeClient({
  region: 'eu-north-1', // Update with your preferred AWS region
});

// Model fallback configuration
type ModelId = 'eu.anthropic.claude-sonnet-4-20250514-v1:0' | 'eu.anthropic.claude-3-7-sonnet-20250219-v1:0' | 'eu.amazon.nova-pro-v1:0';
